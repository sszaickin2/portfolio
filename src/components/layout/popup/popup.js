...
class Popup {
	...
	eventsPopup() {
		...
		document.addEventListener("click", function (e) {
			...
			// Закрытие по пустому месту (popup__wrapper) и кнопки закрытия (popup__close) для закрытия
	...
	open(selectorValue) {
		if (bodyLockStatus) {
			...
			// Если передан селектор (селектор настраивается в options)
			...
			if (this.targetOpen.element) {
				...
				// Создаем своё событие перед открытием попапа
				...
				// Создаем своё событие после открытия попапа
	...
	close(selectorValue) {
		...
		// Создаем своё событие перед закрытием попапа
		...
		// Создаем своё событие после закрытия попапа
